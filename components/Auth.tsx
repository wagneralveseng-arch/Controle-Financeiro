...
export const Auth: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-white rounded-none shadow-2xl overflow-hidden border-t-4 border-red-600">
        <div className="p-8">
          ...
          {error && (
           ...
           {message && (
            <div className="mb-4 p-3 bg-green-50 border border-green-200 text-green-700 text-sm font-medium flex items-center gap-2">
              <span>✅</span> {message}
            </div>
          )}
          ...
          <form onSubmit={handleAuth} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full border border-slate-300 pl-10 p-2 text-sm focus:border-slate-900 outline-none transition-colors"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-slate-900 text-white py-3 font-bold uppercase text-xs hover:bg-slate-800 transition-colors flex items-center justify-center gap-2 mt-4"
            >
          ...
          <div className="mt-6 text-center border-t border-slate-100 pt-4">
            <button
              ...
              className="text-xs font-bold text-slate-500 uppercase hover:text-red-600 transition-colors"
            >
